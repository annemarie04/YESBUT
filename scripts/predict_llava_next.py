...
llava_model = LlavaNextForConditionalGeneration.from_pretrained("llava-hf/llava-v1.6-34b-hf", 
...
llava_processor = LlavaNextProcessor.from_pretrained("llava-hf/llava-v1.6-34b-hf",use_fast=True,add_prefix_space=True)
...
def llava_inference(instruction, image_path):
    ...
    inputs.to(device)
    # Generate
    generate_ids = llava_model.generate(**inputs, max_length=1024)
...
def main():
    ...
    parser.add_argument('--use_caption', type=bool, default=False)
